...
class GuanInfoService(BaseService):
    ...
    @property
    def opType(self):
        if not self.activityRecord.boy_passport_id:
            return const.GUAN_INFO_OP_TYPE_INVITE
        elif self.activityRecord.boy_passport_id == self.passportId and self.activityRecord.girl_passport_id:
        ...
        elif not self.activityRecord.girl_passport_id:
    ...
    def opDesc(self):
        return {
            const.GUAN_INFO_OP_TYPE_INVITE: "报名",
    ...
    def activityOprete(self, opType):
        ...
        if opType == const.GUAN_INFO_OP_TYPE_INVITE:
            ...
            updateParams['boy_passport_id'] = self.activityRecord.girl_passport_id
            updateParams['girl_passport_id'] = 0
        ...
        if opType == const.GUAN_INFO_OP_TYPE_INVITE_QUIT_AFTER_ACCEPT:
            ActivityChangeRecordModel.addOne(self.dbSession, self.activityId, self.activityRecord.girl_passport_id,
