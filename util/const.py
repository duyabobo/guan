...
MODEL_USER_OP_TYPE_BIRTH_YEAR_CHOICE_LIST = range(CURRENT_YEAR - MAX_AGE, CURRENT_YEAR - MIN_AGE + 1)
...
MODEL_USER_OP_TYPE_HEIGHT_PERIOD_ARRAY = range(MIN_HEIGHT, MAX_HEIGHT)
...
MODEL_USER_OP_TYPE_MONTH_PAY_PERIOD_ARRAY = range(MIN_MONTH_PAY, MAX_MONTH_PAY, 1000)
