...
MODEL_USER_OP_TYPE_BIRTH_YEAR_CHOICE_LIST = ["是", "否"]  # range(MODEL_USER_OP_TYPE_BIRTH_YEAR_START, MODEL_USER_OP_TYPE_BIRTH_YEAR_END)
MODEL_USER_OP_TYPE_DEFAULT_BIRTH_YEAR_INDEX = 0  # MODEL_USER_OP_TYPE_BIRTH_YEAR_CHOICE_LIST.index(CURRENT_YEAR - GOOD_AGE)
MODEL_USER_OP_TYPE_MARTIAL_STATUS = 3
MODEL_USER_OP_TYPE_DEFAULT_MARTIAL_STATUS_INDEX = 0
MODEL_USER_OP_TYPE_MARTIAL_STATUS_CHOICE_LIST = ["是", "否"]
MODEL_USER_OP_TYPE_MARTIAL_STATUS_PERIOD_CHOICE_LIST = ["是", "否"]
MODEL_USER_OP_TYPE_HEIGHT = 4
MODEL_USER_OP_TYPE_HEIGHT_CHOICE_LIST = ["是", "否"] # ["<145", "145-150", "150-155", "155-160", "160-165", "165-170", "170-175", "175-180", "180-185", ">185"]  # 如果有改动这个枚举，需要刷数据
MODEL_USER_OP_TYPE_DEFAULT_HEIGHT_INDEX = 0  # 5
MODEL_USER_OP_TYPE_WEIGHT = 5
MODEL_USER_OP_TYPE_WEIGHT_CHOICE_LIST = ["是", "否"]  # ["<40", "40-45", "45-50", "50-55", "55-60", "60-65", "65-70", "70-75", "75-80", ">80"]  # 如果有改动这个枚举，需要刷数据
MODEL_USER_OP_TYPE_DEFAULT_WEIGHT_INDEX = 0  # 3
...
MODEL_USER_OP_TYPE_EDUCATION_CHOICE_LIST = ["是", "否"]  # 如果有改动这个枚举，需要刷数据
...
MODEL_USER_OP_TYPE_HEIGHT_PERIOD_CHOICE_LIST = range(0, 24)  # range(MIN_HEIGHT, MAX_HEIGHT)
MODEL_USER_OP_TYPE_WEIGHT_PERIOD = 10
MODEL_USER_OP_TYPE_WEIGHT_PERIOD_CHOICE_LIST = range(0, 24)  # range(MIN_WEIGHT, MAX_WEIGHT)
