...
def GET_BIRTH_YEAR_PERIOD_CHOICE_LIST():
    minYear = GET_MODEL_USER_OP_TYPE_BIRTH_YEAR_START()
    maxYear = GET_MODEL_USER_OP_TYPE_BIRTH_YEAR_END()
    return ["%s-%s" % (b, b+3) for b in range(minYear, maxYear, 3)]
...
MODEL_USER_OP_TYPE_BIRTH_YEAR_PERIOD_CHOICE_LIST = GET_BIRTH_YEAR_PERIOD_CHOICE_LIST()
