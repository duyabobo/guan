...
MODEL_SEX_MALE = 1
MODEL_SEX_FEMALE = 2
# MODEL_USER_OP_TYPE_ENUMERATE
MODEL_USER_OP_TYPE_VERIFY = 0
MODEL_USER_OP_TYPE_SEX = 1
MODEL_USER_OP_TYPE_SEX_CHOICE_LIST = ["", "男", "女"]
MODEL_USER_OP_TYPE_BIRTH_YEAR = 2
MODEL_USER_OP_TYPE_DEFAULT_BIRTH_YEAR = 1995
MODEL_USER_OP_TYPE_MARTIAL_STATUS = 3
MODEL_USER_OP_TYPE_MARTIAL_STATUS_CHOICE_LIST = ["", "未婚", "离异"]
MODEL_USER_OP_TYPE_HEIGHT = 4
MODEL_USER_OP_TYPE_HEIGHT_CHOICE_LIST = ["<140cm", "140-150cm", "150-160cm", "160-170cm", "170-180cm", ">180cm"]
MODEL_USER_OP_TYPE_WEIGHT = 5
MODEL_USER_OP_TYPE_WEIGHT_CHOICE_LIST = ["<40kg", "40-50kg", "50-60kg", "60-70kg", "70-80kg", ">80kg"]
MODEL_USER_OP_TYPE_MONTH_PAY = 6
MODEL_USER_OP_TYPE_MONTH_PAY_CHOICE_LIST = ["<4000元", "4000-10000元", "10000-20000元", "20000-30000元", "30000-50000元", ">50000元"]
MODEL_USER_OP_TYPE_EDUCATION = 7
MODEL_USER_OP_TYPE_EDUCATION_CHOICE_LIST = ["", "高中及以下", "专科", "本科", "硕士", "博士及以上"]
