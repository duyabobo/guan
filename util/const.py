...
def GET_MODEL_USER_OP_TYPE_BIRTH_YEAR_PERIOD_ARRAY():
    return range(MODEL_USER_OP_TYPE_BIRTH_YEAR_START, MODEL_USER_OP_TYPE_BIRTH_YEAR_END)
...
MODEL_USER_OP_TYPE_BIRTH_YEAR_PERIOD_ARRAY = GET_MODEL_USER_OP_TYPE_BIRTH_YEAR_PERIOD_ARRAY()
