...
RESP_NEED_VERIFY = {'code': 1101, 'errMsg': '请完成认证'}
RESP_NEED_FILL_SEX = {'code': 1102, 'errMsg': '请完善性别'}
RESP_NEED_FILL_BIRTH_YEAR = {'code': 1103, 'errMsg': '请完善出生年份'}
RESP_NEED_FILL_HEIGHT = {'code': 1104, 'errMsg': '请完善身高'}
RESP_NEED_FILL_WEIGHT = {'code': 1105, 'errMsg': '请完善体重'}
RESP_NEED_FILL_HOME_REGION = {'code': 1106, 'errMsg': '请完善籍贯'}
RESP_NEED_FILL_STUDY_REGION = {'code': 1107, 'errMsg': '请完善学校城市'}
RESP_NEED_FILL_STUDY_FROM_YEAR = {'code': 1108, 'errMsg': '请完善入学年份'}
RESP_NEED_FILL_EDUCATION = {'code': 1109, 'errMsg': '请完善学校信息'}
RESP_NEED_FILL_MARTIAL_STATUS = {'code': 1110, 'errMsg': '请完善婚姻状态'}
