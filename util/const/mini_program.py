...
MYINFORMATION_PAGE = '/page/my_information/my_information?title=时间安排'  # 时间安排
MYINFORMATION_PAGE_WITH_ERRMSG = '/page/my_information/my_information?title=时间安排&errMsg=请完善个人信息'  # 时间安排
MYREQUIREMENT_PAGE = '/page/my_requirement/my_requirement?title=具体时间'  # 具体时间
